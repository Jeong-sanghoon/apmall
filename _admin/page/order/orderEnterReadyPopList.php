...
<script>
	...
	function goUpdate(purchase_seq){
		location.href = "orderEnterReadyPopInput.php?<?=$gStr?>&purchase_seq="+ purchase_seq;
	}
	...
	function doDelete(){
		...
		if(confirm("삭제하시겠습니까?")){
			...
			var url = "orderEnterReadyPopProc.php";
	...
	// 입고확인페이지이동
	function goEnter(){
		location.href = "orderEnterReadyPopEnter.php?<?=$gStr?>";
	}
</script>
	...
	<div id='contain'>
		...
		<div id='content_wrap'> <!-- 100%의 전체 컨텐츠 영역-->
			...
			<div class='content w100p'> <!-- 원하는 컨텐츠 넓이를 추가 w960 클래스는 width:960px란 의미 -->
				...
				<div class='mt10'>
					<p class='fr'>
						<input type='button' value='입고확인' class='btn_02 w80' onclick="javascript:goEnter();"/>
					</p>
				</div>
