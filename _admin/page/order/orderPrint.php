...
<script type="text/javascript">
	...
	function doExcel(type){
		...
		location.href = "orderPrintProc.php?cal_1="+ cal_1 +"&cal_2="+ cal_2 +"&type="+ type;
	}
</script>
	...
	<div id='contain'>
		...
		<div id='content_wrap'> <!-- 100%의 전체 컨텐츠 영역-->
			...
			<div class='content w100p'> <!-- 원하는 컨텐츠 넓이를 추가 w960 클래스는 width:960px란 의미 -->
				...
				<div class='mt10'>
					<p class='tc'>
						<input type='button' value='COD내려받기' class='btn_b01 w120' onclick="javascript:doExcel('cod');"/>
						<input type='button' value='면장내려받기' class='btn_b01 w120' onclick="javascript:doExcel('order');"/>
					</p>					
				</div>
<?
