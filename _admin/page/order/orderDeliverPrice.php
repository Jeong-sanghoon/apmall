...
<script type="text/javascript">
	...
	// 입력페이지 이동
	function goInput(){
		location.href = "orderDeliverPriceInput.php?<?=$gStr?>";
	}
</script>
...
?> 
				...
				<div class='mt10'>
					...
					<p class='fr'>
						<input type='button' value='입력' class='btn_02 w80' onclick="javascript:goInput();"/>
					</p>
				</div>
...
?>
					<tr>
						...
						<td><?=number_format($ds['REAL_WEIGHT'], 2, ',', ',')?>KG</td>
						<td><?=number_format($ds['REAL_W_PRICE'])?>원</td>
						<td><?=$ds['HBL_CD']?></td>
					</tr>
<?
		}
